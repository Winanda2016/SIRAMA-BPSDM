        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <form method="POST" action="{{ route('pegawai_reservasiKamar.update', ['id' => $data->transaksi_id]) }}" enctype="multipart/form-data" class="reservationForm">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-5">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="number" id="jumlahRuangan" name="jumlah_ruangan" value="{{ $data->jumlah_ruangan }}">
                                </div>
                            </div>
                        </div><br>
