                        ...
                        <table class="table align-middle table-bordered datatable dt-responsive table-check nowrap" style="width: 100%;">
                            ...
                            <tbody align="center">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 30%;  word-wrap: break-word; white-space: normal;">{{ $km->saran_pengaduan }}</td>
                                    ...
                                    <td style="width: 10%;">
                                        <div class="d-flex justify-content-center" align="center">
                                            <button type="button" class="btn btn-warning waves-effect waves-light p-1" title="edit" data-bs-toggle="modal" data-bs-target="#editSP{{ $km->saran_pengaduan_id }}" style="width: 35px; height:30px; margin-right:15px">
                                                <i class="bx bxs-edit font-size-16 align-middle"></i>
                                            </button>

                                            <!-- Modal Saran dan pengaduan -->
                                            <div class="modal fade" id="editSP{{ $km->saran_pengaduan_id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="editSPLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content border-primary">
                                                        ...
                                                        <div class="modal-body" align="left">
                                                            <form class="row g-3" method="POST" action="{{ route('saran-pengaduan.update', ['saran_pengaduan' => $km->saran_pengaduan_id]) }}">
                                                                @csrf
                                                                @method('PUT')
                                                                <div class="mb-2">
                                                                    <label for="example-text-input" class="form-label">Saran dan Pengaduan</label>
                                                                    <textarea id="fasilitas" name="saran_pengaduan" class="form-control" rows="2" readonly>{{ $km->saran_pengaduan }}</textarea>
                                                                </div>
                                                                <div class="mb-3">
                                                                ...
                                                                <div class="row">
                                                                    <label for="status" class="form-label">Status SaranPengaduan</label>
                                                                    <div class="col-sm-3">
                                                                        <div class="form-check mb-3">
                                                                            <input class="form-check-input" type="radio" name="status" id="status_tampil" value="tampil" checked>
                                            ...
                                            <form id="delete-{{ $km->saran_pengaduan_id }}" method="POST" action="{{ route('saran-pengaduan.destroy', $km->saran_pengaduan_id) }}">
                                                @csrf
                                                @method('DELETE')
                                                <button type="button" class="btn btn-danger waves-effect waves-light p-1 sa-warning" data-id="{{ $km->saran_pengaduan_id }}" title="hapus" style="width: 35px; height:30px; margin-right:5px">
