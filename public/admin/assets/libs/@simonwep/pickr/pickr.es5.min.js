                ...
                { target: "Array", proto: !0, forced: !f },
                {
                    slice: function (t, e) {
                        ...
                        if (
                            ...
                            return v.call(f, g, y);
                        for (
                            n = new (void 0 === r ? Array : r)(h(y - g, 0)),
                                l = 0;
                            g < y;
                            g++, l++
                        )
                ...
                return [
                    ...
                    function (t, n) {
                        ...
                        for (var x = []; ; ) {
                            ...
                            if ((x.push(S), !m)) break;
                            "" === String(S[0]) &&
                                (g.lastIndex = u(y, i(g.lastIndex), w));
                        }
        ...
        function (t, e, r) {
            ...
            function v(t) {
                ...
                return (function t(r) {
                    ...
                    i && (n[i] = r);
                    for (
                        var c = 0, u = Array.from(r.children);
                        c < u.length;
                        c++
                    ) {
                        var s = u[c],
            ...
            function R() {
                ...
                var e = l(t.elements, "click", function (e) {
                    t.elements.forEach(function (r) {
                        return r.classList[e.target === r ? "add" : "remove"](
                            t.className
                        );
                    }),
                        t.onchange(e),
            ...
            var W = (function () {
                function t(e) {
                    ...
                    var x = this;
                    this._setupAnimationFrame = requestAnimationFrame(
                        function t() {
                ...
                return (
                    ...
                    (e._bindEvents = function () {
                        ...
                        if (r.adjustableNumbers) {
                            ...
                            g(e.interaction.result, function (e, r, n) {
                                var o =
                                    i[t.getColorRepresentation().toLowerCase()];
                                if (o) {
                                    var a = o[n],
                                        c = e + (a >= 100 ? 1e3 * r : r);
                                    return c <= 0
                    ...
                    (e._rePositioningPicker = function () {
                        ...
                        if (
                            ...
                            (e.style.top =
                                (window.innerHeight - r.height) / 2 + "px"),
                                (e.style.left =
                                    (window.innerWidth - r.width) / 2 + "px");
                        }
                    }),
                    (e._updateOutput = function (t) {
                        ...
                        if (e.interaction.type()) {
                            var o =
                                "to" +
                                e.interaction.type().getAttribute("data-type");
